           ...
           <div class="col s12 m12 l12">
            <div id="persona" class="col s12 m12 l12  "><!-- blue lighten-4 -->
                 <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                  <input id="idredes" name="idredes" type="hidden" value="<?php echo $valor ?>">
                <div class="col s12 m12 l12">
                    <div class="formcontent">  
                      <div class="row" style="font-size: 18px; border-radius: 5px; border:#CBCBCB 1px solid;">
                        ...
                        <div class="input-field col s12 m4 l4">
                          <input id="iddispositivo" name="iddispositivo" type="text" value="<?php echo $datoss['dispositivo'] ?>" class="validate">
                        ...
                        <div class="input-field col s12 m4 l4">
                          <input id="idipmac" name="idipmac" type="text" value="<?php echo $datoss['ipmac'] ?>" class="validate">
                        ...
                        <div class="input-field col s12 m4 l4">
                          <input id="idvlan" name="idvlan" type="text" value="<?php echo $datoss['vlan'] ?>" class="validate">
                          <label for="idvlan">VLAN</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idfuncion" name="idfuncion" type="text" value="<?php echo $datoss['funcion'] ?>" class="validate">
                          <label for="idfuncion">Función</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idfabricante" name="idfabricante" type="text" value="<?php echo $datoss['fabricante'] ?>" class="validate">
                          <label for="idfabricante">Fabricante</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idfirmware" name="idfirmware" type="text" value="<?php echo $datoss['firmware'] ?>" class="validate">
                          <label for="idfirmware">Firmware</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idpuertos" name="idpuertos" type="text" value="<?php echo $datoss['puertos'] ?>" class="validate">
