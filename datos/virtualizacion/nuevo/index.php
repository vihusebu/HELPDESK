...
<head>
    <?php
      $hd_titulo="NUEVO REGISTRO DE DATOS DE CLOUD Y VIRTUALIZACIÓN";
                ...
                <div class="col s12 m12 l12">
                    <div class="formcontent">  
                      <div class="row" style="font-size: 18px; border-radius: 5px; border:#CBCBCB 1px solid;">
                        ...
                        <div class="input-field col s12 m4 l4">
                          <input id="idrecurso" name="idrecurso" type="text" class="validate">
                        ...
                        <div class="input-field col s12 m4 l4">
                          <input id="idproveedorplataforma" name="idproveedorplataforma" type="text" class="validate">
                          <label for="idproveedorplataforma">Proveedor/Plataforma</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idipendpoint" name="idipendpoint" type="text" class="validate">
                          <label for="idipendpoint">IP/Endpoint</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idcpuramdisco" name="idcpuramdisco" type="text" class="validate">
                          <label for="idcpuramdisco">CPU/RAM/Disco</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idsistemaoperativo" name="idsistemaoperativo" type="text" class="validate">
                          <label for="idsistemaoperativo">IP/Sistema Operativo</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idambiente" name="idambiente" type="text" class="validate">
                          <label for="idambiente">Ambiente (Prod/Dev/Test)</label>
                        </div>
                         
                        <div class="input-field col s12 m4 l4">
                          <input id="idpropietario" name="idpropietario" type="text" class="validate">
                          <label for="idpropietario">Propietario</label>
                        </div>
                       
                        <div class="input-field col s12 m4 l4">
                          <input id="idfechacreado" name="idfechacreado" type="date" class="validate">
