...
<head>
    <?php
      $hd_titulo="NUEVO REGISTRO DE DATOS DE INFRAESTRUCTURA";
                ...
                <div class="col s12 m12 l12">
                    <div class="formcontent">  
                      <div class="row" style="font-size: 18px; border-radius: 5px; border:#CBCBCB 1px solid;">
                        ...
                        <div class="input-field col s12 m4 l4">
                          <input id="idcompomente" name="idcompomente" type="text" class="validate">
                        ...
                        <div class="input-field col s12 m4 l4">
                          <input id="idubicacionfisica" name="idubicacionfisica" type="text" class="validate">
                          <label for="idubicacionfisica">Ubicación Física</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idubicionlogica" name="idubicionlogica" type="text" class="validate">
                          <label for="idubicionlogica">Ubicación Lógica</label>
                        </div>
                        <div class="input-field col s12 m4 l4">
                          <input id="idipdirewall" name="idipdirewall" type="text" class="validate">
                        ...
                        <div class="input-field col s12 m4 l4">
                          ...
                          <select id="idmantenimiento" name="idmantenimiento">
                            <option value="0">Seleccionar...</option>
                            <?php
                            foreach($dominio->mostrarTodo("tipo='MANTEINFRAES' ") as $f)
                            {
                              ?>
                                <option value="<?php echo $f['iddominio']; ?>"><?php echo $f['nombre']; ?></option>
                              <?php
                        ...
                        <div class="input-field col s12 m4 l4">
                          <input id="iddocumentacion" name="iddocumentacion" type="text" class="validate">
