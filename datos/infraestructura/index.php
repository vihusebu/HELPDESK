...
<head>
    <?php
      $hd_titulo="LISTA DE REGISTRO DE DATOS INFRAESTRUCTURA";
              ...
              <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                ...
                <table id="example2" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php
                    $contar=0;
                    foreach($infraestructura->mostrarTodo("") as $f)
                    {
                      $domestado=$dominio->muestra($f['estado']);   
                      $dommanteni=$dominio->muestra($f['mantenimiento']);                 
                      $lblcode=ecUrl($f['idinfraestructura']);
                      $contar++;
                    ?>
                    <tr style="<?php echo $estilo ?>">
                      <td><?php echo $contar ?></td>
                      <td><?php echo $f['codigo'] ?></td>
                      <td><?php echo $f['compomente'] ?></td>
                      <td><?php echo $f['tipo'] ?></td>
                      <td><?php echo $f['modelo'] ?></td>
                      <td><?php echo $f['ubicacionfisica'] ?></td>
                      <td><?php echo $f['ubicionlogica'] ?></td>
                      <td><?php echo $f['ipdirewall'] ?></td>
                      <td><?php echo $f['responsable'] ?></td>
                      <td><?php echo $domestado['nombre'] ?></td>
                      <td><?php echo $f['fechainstalacion'] ?></td>
                      <td><?php echo $dommanteni['nombre'] ?></td>
                      <td><?php echo $f['documentacion'] ?></td>
                      <td>
                        <a href="editar/?lblcode=<?php echo $lblcode ?>" class="btn-jh waves-effect darken-4 orange"><i class="fa fa-pencil-square"></i> editar</a>
                        <button class="btn-jh waves-effect darken-4 red" onclick="elim('<?php echo $f['idinfraestructura'] ?>');"><i class="fa fa-remov"></i> Eliminar</button>
