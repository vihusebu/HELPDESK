...
<head>
    <?php
      $hd_titulo="LISTA DE REGISTRO DE DATOS DE PERIFERICOS";
                ...
                <table id="example2" class="display" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th>Ubicación</th>
                      <th>Estado</th>
                      <th>Conectado a (Equipo Principal)</th>                      
                  ...
                  <tbody>
                    <?php
                    $contar=0;
                    foreach($periferico->mostrarTodo("") as $f)
                    {
                      $domestado=$dominio->muestra($f['estado']);                    
                      $lblcode=ecUrl($f['idperiferico']);
                      $contar++;
                    ?>
                    <tr style="<?php echo $estilo ?>">
                      ...
                      <td><?php echo $f['nroserie'] ?></td>
                      <td><?php echo $f['marca'] ?></td>
                      <td><?php echo $f['fechaadquisicion'] ?></td>
                      <td><?php echo $f['asignado'] ?></td>
                      <td><?php echo $f['ubicacion'] ?></td>
                      <td><?php echo $domestado['nombre'] ?></td>
                      <td><?php echo $f['conectado'] ?></td>
                      <td><?php echo $f['fechagarantia'] ?></td>
                      ...
                      <td>
                        ...
                        <button class="btn-jh waves-effect darken-4 red" onclick="elim('<?php echo $f['idperiferico'] ?>');"><i class="fa fa-remov"></i> Eliminar</button>
