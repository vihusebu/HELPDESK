                    ...
                    <div class="col s12 m12 l4"><!--green lighten-5-->
                      ...
                      <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                        <div class="input-field col col s12 m6">
                          ...
                          <div class="input-field col col s12 m6" style="font-weight:bold;">
...
function generar2()
{
  ...
  var lbl_us="<?php echo $lblcode ?>";
    popup=window.open('../pdf/solicitudes.php?lblcode='+lbl_us+'&idestado='+idest+'&fechaini='+fechaini+'&fechafin='+fechafin);
