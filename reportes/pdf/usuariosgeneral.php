...
if ($iddominio==0) 
{
  ...
  $consulta="SELECT *
							  FROM vadmejecutivo
							  WHERE activo=1 and idtipo=$iddominio ORDER BY nombre ASC";
}
            ...
            <td style="width:30%;">
	            ...
	            <tr>
	            	<td>
	            		...
	            		<div class="titPRI"><h3>USUARIOS EN EL SISTEMA</h3></div>
	            		<div class=""><h5> </h5></div>
	            	</td>
	            </tr>
	            </table>
		...
		<table class="tablaLIST">
			<thead>
				<tr>
				  ...
				  <th style="text-align:left;">Rol usuario</th>
				...
				foreach($vadmejecutivo->sql($consulta) as $f) 
				{
					$per=$persona->muestra($f['idpersona']);
                      switch ($f['estado']) 
                       {
                         case '0':
                            $estado='<p style="color:red;">DESHABILITADO</p>';
                           break;
