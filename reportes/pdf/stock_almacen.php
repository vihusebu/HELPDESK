...
$consulta="SELECT *
							  FROM vinventario
							  WHERE activo=1  ORDER BY item ASC";

							   $dalmacen=$almacen->muestra($idalmacen);
            ...
            <td style="width:30%;">
	            ...
	            <tr>
	            	<td>
	            		...
	            		<div class="titPRI"><h3>STOCK EN ALMACEN</h3></div>
	            		<div class=""><h5>'.$dalmacen['nombre'].'</h5></div>
	            	</td>
	            </tr>
	            </table>
            </td>
		...
		<table class="tablaLIST">
			<thead>
				<tr>
				  ...
				  <th style="text-align:left;">Und. medida</th>
			...
			<tbody>
				...
				$contar=0; 
				foreach($vinventario->sql($consulta) as $f) 
				{
