...
$consulta="SELECT *
							  FROM movimiento
							  WHERE activo=1 and idadmejecutivo=$valor and motivo=3 ORDER BY fechaingreso ASC";
            ...
            <td style="width:30%;">
	            ...
	            <tr>
	            	<td>
	            		...
	            		<div class="titPRI"><h3>LISTA DE ITEMS ASIGNADOS A USUARIO</h3></div>
	            		<div class=""><h5> </h5></div>
	            	</td>
	            </tr>
	            </table>
		...
		<table class="tablaLIST">
			<thead>
				<tr>
				  ...
				  <th style="text-align:left;">Fecha designado</th>
				  <th style="text-align:left;">Hora designado</th>
				  <th style="text-align:left;">Nombre Item</th>
			...
			<tbody>
				...
				$contar=0; 
				foreach($movimiento->sql($consulta) as $f) 
				{
