...
<head>
  <?php
    $hd_titulo="LISTADO GENERAL DE USUARIOS";
                    ...
                    <div class="col s12 m12 l4"><!--green lighten-5-->
                      ...
                      <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                        ...
                        <div class="input-field col s12 m12 l12">
                          <select id="iddominio" name="iddominio">
                             <label for="idnombre">Nombre area</label>
                            <option value="0">Todos</option>
                            <?php
                              foreach($dominio->mostrarTodo("tipo='CAAS'") as $dom)
                              {
                                ?>
                                  <option value="<?php echo $dom['iddominio']; ?>"><?php echo $dom['nombre'].' '.$veje['paterno']; ?></option>
                                <?php
                              }
                            ?>
                          </select>
...
function generar2()
{
  ...
  var lbl_us="<?php echo $lblcode ?>";
    popup=window.open('../pdf/usuariosgeneral.php?lblcode='+lbl_us+'&iddominio='+iddom);
