            ...
            <div class="row" >
              <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                ...
                <div class="row" >
                  ...
                  <div class="col s12 m6 l6" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                    <?php
                      if (count($dus)>0) {
                        ?>
                          <fieldset>
                            ...
                            <div class="input-field col s12">
                              <button style="width: 100%" id="btnEdit" class="btn cyan darken-4"><i class="fa fa-save"></i> GUARDAR CAMBIOS</button>
                            </div>
                          </fieldset>
                        <?php
                      }
