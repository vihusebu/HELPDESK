        ...
        <section id="content">
          ...
          <div id="breadcrumbs-wrapper">
            <div class="container">
              ...
              <?php
                  if ($ticExiste['estado']==2) 
                  {
                     //EN PROCESO mostrar
                        $lblcode=ecUrl($ticExiste['idticket']);
                        $lblcode2=ecUrl($sol['idsolucion']);
                        $ti3=$tipo->muestra($ticExiste['idtipo']);
                       $are3=$area->muestra($ticExiste['idarea']);
                      ?>
                          <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                              <div class="card">
                                <div class="card-content blue" style="color:white; text-align: center; font-size: 20px;">
                                    <b class="card-stats-title" style="font-weight: bold;">CODIGO: <?php echo $ticExiste['idticket'] ?> <i class="mdi-editor-insert-invitation"></i>Solicitud:  <?php echo $ticExiste['fecha'] ?> </b>
                                    <h4 class="card-stats-number"></h4>
                                </div>
                                <div class="card-action blue darken-2" style="color:white; <?php echo $colornuevo2 ?>">
                                  <!--DESEMBOLSOSO GENERAL-->
                                   
                                    <div class="row">
                                      <div class="col s3 m3 l3"><i class="fa fa-users" style="color: white;"></i> <?php echo $ticExiste['problema'] ?></div>
                                      <div class="col s5 m5 l5" style="text-align: left;"><i class="mdi-action-alarm"></i> <?php echo $ticExiste['descripcion'] ?></div>
                                      <div class="col s2 m2 l2" style="text-align: right;"><i class="fa fa-money"></i>  <?php echo $are3['nombre'] ?></div>
                                      <div class="col s2 m2 l2" style="text-align: center;"><i class="fa fa-user"></i> <?php echo $ti3['nombre'] ?></div>
                                    </div>
                                  <div class="row">
                                     <div class="col s12 m12 l12">&nbsp;</div>
                                  
                                  <div class="col s12 m12 l12" style="text-align: center;"><a  href="detalle.php?lblcode=<?php echo $lblcode; ?>&lblcode2=<?php echo $lblcode2; ?>" class="btn waves-effect waves-light darken-4 blue"> <i class="fa fa-edit (alias)"></i> Seguir el proceso </a></div>
                                  </div>
                    ...
                    //SIN PENDIENTE (asignar nuevo)
                      ...
                      if (count($ticSelec)>0) 
                      {
                        ...
                        // EXISTE TICKET PENDIENTES para asignar                        
                         ?>
                          <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                              <div class="card">
                                <div class="card-content orange" style="color:white; text-align: center; font-size: 20px;">
                                    <b class="card-stats-title" style="font-weight: bold;">CODIGO: <?php echo $ticSelec['idticket'] ?> <i class="mdi-editor-insert-invitation"></i>Solicitud:  <?php echo $ticSelec['fecha'] ?> </b>
                                    <h4 class="card-stats-number"></h4>
                                </div>
                                <div class="card-action orange darken-2" style="color:white; <?php echo $colornuevo2 ?>">
                                  <!--DESEMBOLSOSO GENERAL-->
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col s2 m2 l2" style="text-align: right;"><i class="fa fa-money"></i>  <?php echo $are2['nombre'] ?></div>
                                      <div class="col s2 m2 l2" style="text-align: center;"><i class="fa fa-user"></i> <?php echo $ti2['nombre'] ?></div>
                                    </div>
                                  <div class="row">
                                     <div class="col s12 m12 l12">&nbsp;</div>
                                  
                                  <div class="col s12 m12 l12" style="text-align: center;"><button class="btn waves-effect waves-light green" onclick="iniciarpantalla('<?php echo $ticSelec['idticket'] ?>','<?php echo $ticSelec['problema'] ?>');"> <i class="fa fa-edit (alias)"></i> INICIALIZAR </button></div>
                                  </div>
                                 <!--FIN DESEMBOLSOSO GENERAL-->
                        ...
                        // NO EXISTE PENDIENTES DE SOLICITUD DE TICKET
                        ?>
                        <div class="col s12 m12 l12">NO HAY PENDIENTES DE SOLICITUD DE TICKET</div>
                        <?php
                      }
                  }
                        ...
                        switch ($f['estado']) 
                       {
                         case '1':
                                ?>
                                  ...
                                  <!--<button class="btn waves-effect waves-light green" onclick="iniciarpantalla('<?php //echo $f['idticket'] ?>','<?php// echo $f['problema'] ?>');"> <i class="fa fa-edit (alias)"></i> INICIALIZAR </button> PENDIENTE-->
                               <?php;
                           break;
                ...
                <div id="modal2" class="modal">
                  <div class="modal-content">
                      ...
                      <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                        ...
                        <div class="col s12 m12 l12" style="background: white; text-align: center; color:#0087AF; font-size: 25px; border-radius: 5px; border: #CBCBCB 1px solid; font-weight: bold;">
                INICIALIZANDO LA SOLICITUD DE TICKET...</div>
                         <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                          <input type="hidden" name="idticketImport" id="idticketImport" value="">
                          <input type="text" name="idadmejecutivo" id="idadmejecutivo" value="<?php echo $vadmeje['idvadmejecutivo'] ?>">
