...
<head>
    <?php
      $hd_titulo="LISTA DE DESIGNACIÓN DE SOLICITUDES DE TICKETS";
              ...
              <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                ...
                <table id="example2" class="display" cellspacing="0" width="100%">
                  <div class="col s12 m12 l12" style="text-align:center;">
                   <b style="color:#024873;">Normal: </b><b>Directo al proceso</b><br>
                  <b style="color:#efb810;">ESPECIAL: </b> <b>Se requiere proceso de aprobanción de Jefe de Área, mientras no se apruebe estara pendiente</b>
                  </div>
                  <thead>
                    <tr>
                      <th>Cod</th>
