...
include_once($ruta."class/contingencia.php");
...
switch ($tic['estado']) 
 {
  ...
  echo "
   ...
   <div class='row' style='background: #7AAD4E; text-align: center; color:white; font-size: 20px; border-radius: 5px;'>Fecha solicitud: <b>".$tic['problema']."</b></div>
