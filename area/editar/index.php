<?php
 ...
 $valor=dcUrl($lblcode);
 $car=$area->muestra($valor);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <?php
      $hd_titulo="ACTUALIZAR AREA";
           ...
           <div class="col s12 m12 l12">
            <div id="persona" class="col s12 m12 l12  "><!-- blue lighten-4 -->
                 <form class="col s12" id="idform" action="return false" onsubmit="return false" method="POST">
                  <input id="idarea" name="idarea" type="hidden" value="<?php echo $valor ?>">
                <div class="col s12 m12 l12">
                    <div class="formcontent">  
                      <div class="row" style="font-size: 18px; border-radius: 5px; border:#CBCBCB 1px solid;">
                       
                        <div class="input-field col s12 m12 l12">
                          <input id="idnombre" name="idnombre" type="text" value="<?php echo $car['nombre'] ?>" class="validate">
                          <label for="idnombre">Nombre area</label>
                        </div>
                        <div class="input-field col s12 m12 l12">
                          <input id="iddescripcion" name="iddescripcion" type="text" value="<?php echo $car['descripcion'] ?>" class="validate">
