...
<head>
    <?php
      $hd_titulo="LISTA DE ITEMS ASIGANDOS";
            ...
            <div class="section">
              ...
              <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                ...
                <table id="example2" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php
                    foreach($movimiento->mostrarTodo("motivo=3") as $f)//idtipo=142
                    {
                      
                       $inven=$inventario->muestra($f['idinventario']);
                       $lblcode=ecUrl($f['idmovimiento']);
                    ?>
                    <tr style="">
                       ...
                       <td><?php echo $f['cantidad'] ?></td>
                         <td><a class="btn blue" href="proceder.php?lblcode=<?php echo $lblcode ?>"><i class="fa fa-list-alt"></i> Iniciar</a></td>
