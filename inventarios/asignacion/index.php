...
<head>
  <?php
    $hd_titulo="SELECCIONAR ITEM PARA LA ASIGNACION DE ".$datosalmacen['nombre'];
    ...
    <div id="main">
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div class="container">
            <div class="section">
              <div class="row" style="background: white; text-align: center; color:#024873; border-radius: 5px; border: #CBCBCB 1px solid;">
                  <div class="col s12 m12 l12" align="right">
                  <a class="btn red" href="almacen.php"><i class="fa fa-reply"> </i> Atrás</a>
                </div>
             <fieldset class="formulario">
                   <legend><div><i class="fa fa-list-alt"></i> <strong>LISTA DE ITEMS</strong> </div></legend> 
                        ...
                        <td>
                         <?php
                            ...
                            <?php
                              ...
                              <a class="btn blue" href="asignar.php?lblcode=<?php echo $lblcode ?>&lblcode2=<?php echo $lblcode2 ?>"><i class="fa fa-list-alt"></i> Seleccionar</a>
                                <?php
                              }
