...
<head>
    <?php
      $hd_titulo="LISTA GENERAL TIPO PROBLEMA";
              ...
              <div class="col s12 m12 l12" style="border-radius: 5px; border: 1px solid #E8E8E8; background: white;">
                ...
                <table id="example2" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php
                    $contar=0;
                    foreach($tipo->mostrarTodo("estado=1") as $f)
                    {
                                        
                      $lblcode=ecUrl($f['idtipo']);
                      $contar++;
                    ?>
                    <tr style="<?php echo $estilo ?>">
                      ...
                      <td>
                        ...
                        <button class="btn-jh waves-effect darken-4 red" onclick="elim('<?php echo $f['idtipo'] ?>');"><i class="fa fa-remov"></i> Eliminar</button>
